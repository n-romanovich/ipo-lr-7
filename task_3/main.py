...
#Функция выбора из меню номер 1
def menu_one(): 
    global operations   #Использовать глобальную переменную operations
...
#Функция выбора из меню номер 2
def menu_two():
    global operations   #Использовать глобальную переменную operations
    ...
    for i in range(len(data)): #Цикл
        if data[i]["id"] == search_id: #Сравнение id
            ...
            found = True #Нашли
        if found == False: #Если не нашли
            print("Запись с таким id не найдена") #Сообщение
    operations += 1 #Прибавить операцию

#Функция выбора из меню номер 3
def menu_three():
    global operations   #Использовать глобальную переменную operations
...
#Функция выбора из меню номер 4
def menu_four():
    global operations   #Использовать глобальную переменную operations
...
#Функция выбора из меню номер 5
def menu_five():
    global operations   #Использовать глобальную переменную operations
...
functions = [menu_one, menu_two, menu_three, menu_four, menu_five]  #Список с функциями
data = file_open()

while True: #Бесконечный цикл

    disp_menu() #Вызов функции с выводом на экран меню

    choice = input("Ваш выбор: ") #Ввод пункта меню

    functions[int(choice) - 1]()  #Выбор функции по ее номеру из списка functions